...
# 
# plot(NFarea)
# temp <- crs(raster('Raster/2_NDVI/NF/X2018.07.30_NF_seq_msp_index_ndvi_snow.tif'))
# 
...
# 
# writeOGR(NFarea, "Vector/AreaOutlines/NFarea.shp", driver="ESRI Shapefile", layer='NFarea')
# writeOGR(NTarea, "Vector/AreaOutlines/NTarea.shp", driver="ESRI Shapefile", layer='NTarea')
# writeOGR(VJarea, "Vector/AreaOutlines/VJarea.shp", driver="ESRI Shapefile", layer='VJarea')
# writeOGR(KJarea, "Vector/AreaOutlines/KJarea.shp", driver="ESRI Shapefile", layer='KJarea')
